    ...
    >
      <div className="sidebar-top">
        <div className="sidebar-brand">
          ...
          <span className="sidebar-brand-text">DriveEase</span>
        </div>
      ...
      <div className="sidebar-body">
        <div className="sidebar-menu">
          <ul className="menu-list">
            ...
            <li className="menu-item">
              <Link to="/driver" className="menu-link">
                <span className="menu-link-icon">
                  <MdOutlineBarChart size={20} />
                </span>
                <span className="menu-link-text">Driver</span>
              </Link>
            </li>
            <li className="menu-item">
              <Link to="/car" className="menu-link">
                <span className="menu-link-icon">
                  <MdOutlineBarChart size={20} />
                </span>
                <span className="menu-link-text">Cars</span>
              </Link>
            </li>
            <li className="menu-item">
              <Link to="/bike" className="menu-link">
                <span className="menu-link-icon">
                  <MdOutlineBarChart size={20} />
                </span>
                <span className="menu-link-text">Bikes</span>
              </Link>
            </li>
